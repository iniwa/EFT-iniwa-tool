// src/data/keyPresets.js
// Wiki (https://wikiwiki.jp/eft/%E9%8D%B5) の情報を反映したプリセットデータ
// ※重複IDはマージ済み (Customs/Streets, Shoreline/Woods, Streets/Ground Zero)
...
export const KEY_PRESETS = {
  ...
  // ★マージ: Customs + Streets の両方に存在 → メモを統合
  '6761a6f90575f25e020816a4': {
    rating: 'C',
    memo: '【箱】金庫x2, 武器箱x0-2, ダッフルバッグ, ドロワー 【床】情報書類 (Company Director / Customs+Streets)',
  ...
  // ★マージ: Shoreline + Woods の両方に存在 → メモを統合
  '664d3ddfdda2e85aca370d75': {
    rating: 'B',
    memo: '【箱】ダッフルバッグx1～2 【床】カスタム武器 (水力発電所 Voron / Shoreline+Woods)',
  }, // Voron's hideout key
  ...
  // ★マージ: Streets + Ground Zero の両方に存在 → メモを統合
  '6581998038c79576a2569e11': {
    rating: 'C',
    memo: '【箱】レジ (お金) (Unity Bank / Streets+Ground Zero)',
  ...
  '658199aa38c79576a2569e13': {
    rating: 'B',
    memo: '【床】電子機器, HDD, 貴重品 【箱】PC, ドロワー (TG Science / Streets+Ground Zero)',
  ...
  '6582dc4b6ba9e979af6b79f4': {
    rating: 'B',
    memo: '【箱】武器箱x2, 弾薬 (MVD / Streets+Ground Zero)',
